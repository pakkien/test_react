        ...
        <Page container='fluid'>
            ...
            <Card>
                <CardBody>
                            ...
                            <Dropdown>
                                ...
                                <DropdownMenu>
                                    {qv_props.data.map((rev:any) => { return(
                                        ...
                                        >
                                        {(rev.variance == 0)? 'Quotation': 'Variation ' + rev.variance}
                                        </DropdownItem>)
                                    })}
                    ...
                    <div hidden={activeTab != 'Attachments'} key={'attachmentsTab' + currentVariance}>
                        <AttachmentsView
                            quotation_id={qv_props.quotation_id}
                            variance={currentVariance}
                        />
                    </div>
                    <div hidden={activeTab != 'Revisions'} key={'revisionsTab' + currentVariance}>
                        <RevisionsView
                            quotation_id={qv_props.quotation_id}
                            variance={currentVariance}
                        />
